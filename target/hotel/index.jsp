...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
              $.ajax({
                    url:"${pageContext.request.contextPath}/find/Room?start=0&end=10",
                    type:"post",
                    data:"null",
...
<div id="k">
    <div id="p"><img src="${pageContext.request.contextPath}/img/8.png" width="80px" height="60px"/><font size="6">&nbsp;&nbsp;欢迎入住小海豚自助酒店</font>&nbsp;&nbsp;&nbsp;&nbsp;<img src="${pageContext.request.contextPath}/img/8.png" width="80px" height="60px"/>
        ...
        <c:if test="${not empty user}"><div class="myroom"><font size="3"><a href="${pageContext.request.contextPath}/RoomServlet?method=myRoom&userName=${user.userName}">我的房间</a></font></div></c:if>
        <c:if test="${not empty user}"><div class="myroom"><font size="3"><a href="${pageContext.request.contextPath}/MoneyServlet?method=money&userName=${user.userName}">个人信息</a></font></div></c:if>
