...
<head>
    ...
    <style>
        ...
        #p{display: inline;color: #28A4C9; font-weight: bold; margin-left: 150px;}
        #time{display: inline;color: #28A4C9;margin-left: 10px;}
...
<div id="k">
    <div id="p"><img src="${pageContext.request.contextPath}/img/8.png" width="80px" height="60px"/><font size="6">&nbsp;&nbsp;欢迎入住小海豚自助酒店</font>&nbsp;&nbsp;&nbsp;&nbsp;<img src="${pageContext.request.contextPath}/img/8.png" width="80px" height="60px"/>
        ...
        <c:if test="${empty user}"><div class="myroom"><font size="3"><a href="${pageContext.request.contextPath}/find/myRoom?userName=${user.userName}">我的房间</a></font></div></c:if>
        <c:if test="${empty user}"><div class="myroom"><font size="3"><a href="${pageContext.request.contextPath}/user/balance?userName=${user.userName}">个人信息</a></font></div></c:if>
        <c:if test="${not empty user}"><div class="deng"><font size="3"><a href="${pageContext.request.contextPath}/jsp/login.jsp">登陆</a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/jsp/register.jsp">注册</a></font></div></c:if>
        <c:if test="${empty user}"><div style="float: right;margin-right: 80px;margin-top:40px;font-weight: bold;"><font size="3">欢迎您&nbsp;&nbsp;,&nbsp;&nbsp;${user.userName}&nbsp;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/user/Quit">退出</a></font></div></c:if>
    </div>
</div>
