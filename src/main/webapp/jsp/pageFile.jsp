...
<div style="text-align:center">
    ...
    <ul class="pagination">
        <li>
            <a>共${page.totalPageNum}页</a>
        </li>
        <li>
            <a>第${page.currentPageNum}页</a>
        </li>
        ...
        <c:forEach begin="${page.startPage}" end="${page.endPage}" var="pagenum">
            <%-- <a href="${pageContext.request.contextPath}/${page.url}&num=${pagenu}">${pagenum}</a>--%>
        ...
        <li>
            <a><input style="height: 20px" type="text" id="pagenum" name="pagenum" size="1"/></a>
        </li>
        <li>
            <a href="javascript:void(0);" onclick="jump()">前往</a>
        </li>
    </ul>
